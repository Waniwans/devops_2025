  ...
  return (
    <section className="px-8">
      <div className="container mx-auto mb-20 text-center">
        ...
        >
         We're not just developers we're digital problem solvers. With a passion for innovation and a user-first approach, we deliver high-quality web and mobile solutions that are both functional and visually compelling.
        </Typography>
      </div>
